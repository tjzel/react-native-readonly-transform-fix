...
# else() string(APPEND CMAKE_CXX_FLAGS " -fexceptions -frtti
# -std=c++${CMAKE_CXX_STANDARD} -Wall -Werror") endif()
...
# else() target_link_libraries(reanimated ReactAndroid::react_nativemodule_core)
# endif()
