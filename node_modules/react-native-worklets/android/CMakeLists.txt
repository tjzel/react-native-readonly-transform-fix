...
string(
  APPEND
  CMAKE_CXX_FLAGS
  " -DREACT_NATIVE_MINOR_VERSION=2137\
...
# Consume shared libraries and headers from prefabs add_library(fbjni SHARED
# IMPORTED) add_library(ReactAndroid SHARED IMPORTED)
find_package(fbjni REQUIRED CONFIG)
find_package(ReactAndroid REQUIRED CONFIG)
# message(STATUS "ReactAndroid package found:") message(FATAL_ERROR "  Version:
# ${ReactAndroid_VERSION}") message(FATAL_ERROR "  Include dirs:
# ${ReactAndroid_INCLUDE_DIRS}") message(FATAL_ERROR "  Libraries:
# ${ReactAndroid_LIBRARIES}")
# message(FATAL_ERROR " found ${ReactAndroid_CONSIDERED_CONFIGS}")
